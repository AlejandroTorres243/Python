...
splits = vhouse_df.randomSplit([0.3, 0.7])
train_df = splits[0]
test_df = splits[1]


from pyspark.ml.regression import LinearRegression
lr = LinearRegression(featuresCol = 'features', labelCol='MV', maxIter=4, regParam=0.7, elasticNetParam=0.11)
...
gbt = GBTRegressor(featuresCol = 'features', labelCol = 'MV', maxIter=2)
...
#guardar modelo
dt.save("dt_model.model2.1")
#cargar modelo
model2 = DecisionTreeRegressor.load("dt_model.model2.1")