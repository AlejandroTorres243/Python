...
"""
def boston(randomSplitX, randomSplitY, numSeed, VmaxInter, VregParam, VelasticNetParam):
    ...
    # DF
    splits = vhouse_df.randomSplit([randomSplitX, randomSplitY], seed=numSeed)
    train_df = splits[0]
    test_df = splits[1]
    ...
    lr = LinearRegression(
        ...
        labelCol='MV', maxIter=VmaxInter, regParam=VregParam, elasticNetParam=VelasticNetParam)
    ...
    gbt = GBTRegressor(featuresCol = 'features', labelCol = 'MV', maxIter=VmaxInter)
